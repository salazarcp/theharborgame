...
const gameplayEn: KnowledgePageData = {
  ...
  directAnswer: 'Harbor is a first-person, open-world multiplayer survival game for Windows PC. Its verified loop is to scavenge scarce resources, manage hunger and thirst, craft equipment, build and upgrade shelters, drive after mobile resource targets, trade and take missions inside the only safe zone, then return to an online PvP and co-op world where death can cost everything you carry. Harbor is still in development for Steam Early Access, so details may change before release.',
  ...
  facts: [
    ...
    { label: 'Current status', value: 'Unreleased; planned for Steam Early Access in 2026.' },
  ],
  sections: [
    {
      id: 'core-loop',
  ...
  faqs: [
    ...
    { question: 'Is Harbor already playable?', answer: 'No public release is available on Steam as of July 22, 2026. Steam lists a planned 2026 Early Access release.' },
  ],
...
const releaseEn: KnowledgePageData = {
  ...
  metaDescription: 'Harbor is planned for Steam Early Access in 2026. See the confirmed Windows platform, price status, languages, and official PC system requirements.',
  eyebrow: 'CURRENT RELEASE INFORMATION',
  title: 'Harbor Release Date, Platforms, Price & PC Requirements',
  directAnswer: 'Harbor is planned to enter Steam Early Access in 2026, but CastilvaGames has not announced an exact day or month. The only currently confirmed release platform is Windows PC through Steam. No launch price is displayed, and no official release for Epic Games Store, PlayStation, Xbox, macOS, or Linux is listed as of July 22, 2026. Steam wishlisting is the official way to receive a release notification.',
  updatedLabel: 'Fact-checked July 22, 2026',
  publishedDate: '2026-07-22',
  modifiedDate: '2026-07-22',
  heroImage: '/hero-bg.webp',
  heroAlt: 'Harbor post-apocalyptic open-world survival game key art',
  badges: ['Planned: 2026', 'Steam Early Access', 'Windows PC', 'Price: not announced'],
  factsTitle: 'Release status at a glance',
  facts: [
    { label: 'Planned release', value: '2026; no exact date announced.' },
    { label: 'Release model', value: 'Steam Early Access.' },
    { label: 'Availability', value: 'Not yet available to the public on Steam.' },
    { label: 'Confirmed platform', value: 'Windows PC (64-bit), via Steam.' },
  ...
  sections: [
    {
      ...
      answer: 'The current official window is 2026 for Steam Early Access. An exact release date has not been announced.',
      paragraphs: [
    ...
    },
    {
      ...
      answer: 'Windows PC through Steam is the only confirmed public store platform as of July 22, 2026.',
      table: {
        caption: 'Confirmed and unconfirmed Harbor platforms',
        ...
        rows: [
          ...
          ['Epic Games Store', 'Not announced as a store release', 'Epic Online Services may be used for infrastructure, but that does not confirm an Epic Games Store launch.'],
      ...
      note: '“Not announced” is not the same as “never.” This table records current official evidence and will be updated if CastilvaGames confirms another platform.',
    },
    {
      id: 'price',
  ...
  faqs: [
    ...
    { question: 'Is Harbor coming to Epic Games Store?', answer: 'No Epic Games Store release has been officially announced as of July 22, 2026. Use of Epic Online Services does not by itself confirm an Epic store launch.' },
    { question: 'Is Harbor coming to consoles?', answer: 'No PlayStation or Xbox release is currently listed or announced. Windows PC via Steam is the only confirmed platform.' },
  ...
  sourcesIntro: 'Release details are time-sensitive. This page records the official public listing on the stated check date and avoids filling unknowns with estimates.',
...
const pressEn: KnowledgePageData = {
  ...
  directAnswer: 'Harbor is an upcoming first-person, open-world multiplayer survival game for Windows PC, developed and published by CastilvaGames. Planned for Steam Early Access in 2026, it combines online PvP and co-op with scarce resources, crafting, shelter building, trading, missions, driving, and a post-apocalyptic world built around one safe zone called Harbor. This page is the canonical source for media facts and downloadable first-party assets.',
  updatedLabel: 'Press facts verified July 22, 2026',
  publishedDate: '2026-07-22',
  modifiedDate: '2026-07-22',
  heroImage: '/trailer-thumb.webp',
  heroAlt: 'Harbor official trailer artwork',
  badges: ['Developer: CastilvaGames', 'Steam App 2714930', 'Windows PC', 'Planned 2026 Early Access'],
  ...
  facts: [
    ...
    { label: 'Release status', value: 'Planned for Steam Early Access in 2026; exact date not announced' },
  ...
  sections: [
    ...
    },
    {
      ...
      answer: 'Harbor is an upcoming first-person, open-world multiplayer survival game from CastilvaGames. In a post-apocalyptic wasteland, players manage hunger and thirst, compete for limited resources, craft tools and equipment, build and upgrade shelters, drive vehicles, trade, take missions, and form alliances. Clean Blood and Fuel are critical, while the War Truck and Blackrail create moving resource targets across the world. Harbor itself is the only safe zone, offering temporary protection before players return to online PvP and co-op. Death can cost everything carried. Harbor is planned for Windows PC through Steam Early Access in 2026.',
    },
    {
      id: 'story-angles',
      ...
      bullets: [
        'An upcoming 2026 Steam survival game built around scarcity and high-stakes loss.',
  ...
  faqs: [
    ...
    { question: 'Which Harbor platform is confirmed?', answer: 'Windows PC via Steam is the currently confirmed platform.' },
...
const gameplayTr: KnowledgePageData = {
  ...
  directAnswer: 'Harbor, Windows PC için geliştirilen birinci şahıs bakış açılı açık dünya multiplayer survival oyunudur. Doğrulanmış oyun döngüsü; kıt kaynakları toplamak, açlık ve susuzluğu yönetmek, ekipman üretmek, sığınak kurup geliştirmek, hareketli kaynak hedeflerini araçlarla kovalamak, tek güvenli bölgede ticaret ve görev yapmak, ardından ölümün taşıdığınız her şeye mal olabileceği online PvP ve co-op dünyasına dönmektir. Oyun Steam Early Access için hâlâ geliştirme aşamasındadır; ayrıntılar çıkışa kadar değişebilir.',
  ...
  facts: [
    ...
    { label: 'Güncel durum', value: 'Henüz çıkmadı; 2026 Steam Early Access planlanıyor.' },
  ],
  sections: [
    {
      id: 'temel-dongu',
  ...
  faqs: [
    ...
    { question: 'Harbor şu an oynanabilir mi?', answer: '22 Temmuz 2026 itibarıyla Steam’de herkese açık bir sürüm yoktur. Planlanan çıkış 2026 Steam Early Access’tir.' },
  ],
...
const releaseTr: KnowledgePageData = {
  ...
  metaDescription: 'Harbor’ın 2026’da Steam Early Access’e çıkması planlanıyor. Windows platformu, fiyat durumu, diller ve resmi PC sistem gereksinimleri.',
  eyebrow: 'GÜNCEL ÇIKIŞ BİLGİLERİ',
  title: 'Harbor Çıkış Tarihi, Platformlar, Fiyat ve Sistem Gereksinimleri',
  directAnswer: 'Harbor’ın 2026’da Steam Early Access’e çıkması planlanıyor; ancak CastilvaGames kesin gün veya ay açıklamadı. Şu anda doğrulanan tek çıkış platformu Steam üzerinden Windows PC’dir. 22 Temmuz 2026 itibarıyla çıkış fiyatı gösterilmiyor; Epic Games Store, PlayStation, Xbox, macOS veya Linux sürümü de resmi olarak listelenmiyor. Çıkış bildirimi almanın resmi yolu Steam istek listesidir.',
  updatedLabel: 'Bilgiler 22 Temmuz 2026’da doğrulandı',
  heroAlt: 'Harbor post-apocalyptic açık dünya survival oyunu ana görseli',
  badges: ['Planlanan: 2026', 'Steam Early Access', 'Windows PC', 'Fiyat: açıklanmadı'],
  factsTitle: 'Kısa çıkış özeti',
  facts: [
    { label: 'Planlanan çıkış', value: '2026; kesin tarih açıklanmadı.' },
    { label: 'Çıkış modeli', value: 'Steam Early Access.' },
    { label: 'Erişilebilirlik', value: 'Steam’de henüz herkese açık değil.' },
    { label: 'Doğrulanmış platform', value: 'Steam üzerinden 64-bit Windows PC.' },
  ...
  sections: [
    {
      ...
      answer: 'Güncel resmi aralık 2026 Steam Early Access’tir. Kesin bir çıkış tarihi açıklanmadı.',
      paragraphs: [
    ...
    },
    {
      ...
      answer: '22 Temmuz 2026 itibarıyla resmi olarak doğrulanan tek platform Steam üzerinden Windows PC’dir.',
      table: {
        caption: 'Harbor için doğrulanmış ve açıklanmamış platformlar',
        ...
        rows: [
          ...
          ['Epic Games Store', 'Mağaza çıkışı açıklanmadı', 'Epic Online Services altyapıda kullanılabilir; bu, Epic mağaza çıkışını doğrulamaz.'],
      ...
      note: '“Açıklanmadı”, “hiç çıkmayacak” demek değildir. Yeni resmi duyuru gelirse bu tablo güncellenmelidir.',
    },
    {
      id: 'fiyat',
  ...
  faqs: [
    ...
    { question: 'Harbor Epic Games Store’a çıkacak mı?', answer: '22 Temmuz 2026 itibarıyla Epic Games Store çıkışı resmi olarak açıklanmadı. Epic Online Services kullanılması tek başına Epic mağaza çıkışı anlamına gelmez.' },
    { question: 'Harbor konsollara çıkacak mı?', answer: 'Şu anda PlayStation veya Xbox sürümü listelenmiyor. Doğrulanan tek platform Steam üzerinden Windows PC’dir.' },
  ...
  sourcesIntro: 'Çıkış bilgileri zamanla değişebilir. Bu sayfa belirtilen tarihteki resmi listeyi kaydeder ve bilinmeyenleri tahminle doldurmaz.',
  sources: [officialHarborSource, officialWebsiteSource],
...
const pressTr: KnowledgePageData = {
  ...
  directAnswer: 'Harbor, CastilvaGames tarafından geliştirilen ve yayınlanan, Windows PC için birinci şahıs bakış açılı açık dünya multiplayer survival oyunudur. 2026 Steam Early Access için planlanan oyun; online PvP ve co-op’u kaynak kıtlığı, crafting, sığınak kurma, ticaret, görevler, sürüş ve Harbor adlı tek güvenli bölge çevresindeki post-apocalyptic dünyayla birleştirir. Bu sayfa basın bilgileri ve indirilebilir birinci taraf görseller için resmi merkezdir.',
  updatedLabel: 'Basın bilgileri 22 Temmuz 2026’da doğrulandı',
  heroAlt: 'Harbor resmi fragman görseli',
  badges: ['Geliştirici: CastilvaGames', 'Steam App 2714930', 'Windows PC', 'Planlanan 2026 Early Access'],
  ...
  facts: [
    ...
    { label: 'Platform', value: 'Steam üzerinden Windows PC' },
    { label: 'Çıkış durumu', value: '2026 Steam Early Access planlanıyor; kesin tarih açıklanmadı' },
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        'Kıtlık ve yüksek kayıp riski üzerine kurulan yaklaşan 2026 Steam survival oyunu.',
  ...
  faqs: [
    ...
    { question: 'Harbor için hangi platform doğrulandı?', answer: 'Steam üzerinden Windows PC şu anda doğrulanan platformdur.' },
